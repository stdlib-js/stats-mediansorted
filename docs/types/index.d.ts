...
interface Unary {
	...
	*/
	...
	/**
	* Computes the median value along one or more sorted ndarray dimensions and assigns results to a provided output ndarray.
	*
	* @param x - input ndarray
...
* // returns true
*/
declare const mediansorted: Unary;
